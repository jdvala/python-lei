            ...
            dataframe = pd.DataFrame(
                {
                    ...
                    "Relationship_1_Initial_Registration_Date": [
                        parse(date)
                        for date in lei_results.lei_relationships_1_parent_initial_registration_date
                    ],
                    "Relationship_1_Last_Update_Date": [
                        parse(date)
                        for date in lei_results.lei_relationships_1_parent_last_updated
                    ],
                    ...
                    "Relationship_1_Next_Renewal_Date": [
                        parse(date)
                        for date in lei_results.lei_relationships_1_parent_next_renewal_date
                    ],
                    ...
                    "Relationship_2_Initial_Registration_Date": [
                        parse(date)
                        for date in lei_results.lei_relationships_2_parent_initial_registration_date
                    ],
                    "Relationship_2_Last_Update_Date": [
                        parse(date)
                        for date in lei_results.lei_relationships_2_parent_last_updated
                    ],
                    ...
                    "Relationship_2_Next_Renewal_Date": [
                        parse(date)
                        for date in lei_results.lei_relationships_2_parent_next_renewal_date
                    ],
